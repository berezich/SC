...
public class PersonEndpoint {
    ...
    private static String ERROR_CONFIRM = "������! ���� ������� ������ %s �� ������������!";
    private static String ERROR_CONFIRM_ALREADY = "���� ������� ������ %s ��� ������������!";
    private static String ERROR_CONFIRM_NOTFOUND = "������! ���� ������� ������ %s �� �������!";
    private static String subjectAccountConfirmation = "registration SportConnector";
    private static String msgBodyAccountConfirmation = "��� ��������� ����� ������� ������ ��������� �� ������: " +
            "https://sportconnector-981.appspot.com/confirm.html?id=%s&x=%s";
    private static String ERROR_CONFIRM_EMAIL = "������! ��� email %s �� �������!";
    private static String ERROR_CONFIRM_EMAIL_ALREADY = "��� ������ email %s ��� �������!";
    private static String ERROR_CONFIRM_EMAIL_NOTFOUND = "������! ���� ������� ������ %s �� �������!";
    private static String subjectConfirmEmail = "change Email SportConnector";
    private static String msgBodyConfirmEmail = "��� ����� email ��������� �� ������: " +
            "https://sportconnector-981.appspot.com/email.html?id=%s&x=%s";
    private static String ERROR_CONFIRM_RESET_PASS_NOTFOUND = "������! ��������� ��������� �������������� ������.";
    private static String subjectResetPass = "reset Password SportConnector";
    private static String msgBodyResetPass = "��� ����� ������ ��������� �� ������ " +
            "� �������� ���������� �����������.\n" +
